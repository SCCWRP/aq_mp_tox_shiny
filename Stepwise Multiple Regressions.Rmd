...
#Fit the full model
m1_crust_model_dose <- glm(effect_10 ~ logdose.mg.L.master + size.length.um.used.for.conversions, data = m1_crust_simple, na.action = "na.exclude", family = "binomial")
