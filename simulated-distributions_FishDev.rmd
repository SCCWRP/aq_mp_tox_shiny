---
title: "Simulated Probabilistic Distributions_ Algae DEV"
author: "Scott Coffin"
date: "2/24/2021"
output:   
  html_document:
...
```{r}
#determine which lvl2_f are most abundant for Algae data
crust <- aoc_z %>% 
...
df_pred %>% ggplot(aes(x = factor(vol.L), y = ToxicityProbability)) + 
  ...
  labs(title = "Cumulative Toxicity Probability",
       subtitle = "n = 1000 particles/L; Algae acute Development",
...
prob_summ %>% 
  ...
  labs(title = "Model-Predicted Probability of Toxicity",
       subtitle = "Algae; 14-d exp; Development; NOEC; Early; Marine",
...
#   facet_wrap(~particles.total)
  ...
  # scale_y_continuous(labels = scales::percent)+
  # labs(title = "Cumulative Toxicity Probability",
  #      subtitle = "n = 1000 particles/mL; Algae acute Development",
  #      caption = "Predicted Toxicity from Random Forest")
```
...
Create simulated SSD
Test time. 

BOOTSTRAP to see if it fits the same each time. 

TRY DIFFERENT MODEL TO PROVE THAT OVERFITTING IS NOT OCCURING.
