...
aoc_z <- aoc_ERM %>% # start with Heili's altered dataset (no filtration for terrestrial data)
...
aoc_z$Species <- as.factor(paste(aoc_ERM$genus,aoc_ERM$species)) #must make value 'Species" (uppercase)
                ...
                tabPanel("3: Exploration",
                    ...
                    column(width = 12,
                      ...
                      column(width = 3,
                        ...
                        choices = levels(aoc_ERM$lvl1_f),
                        selected = levels(aoc_ERM$lvl1_f),
                        options = list(`actions-box` = TRUE), # option to de/select all
                        multiple = TRUE)), # allows for multiple inputs
                      ...
                      column(width = 3,
                        ...
                        label = "Polymer:", 
                        choices = levels(aoc_ERM$poly_f),
                        selected = levels(aoc_ERM$poly_f),
                      ...
                      column(width = 3,
                        ...
                        label = "Organisms:", 
                        choices = levels(aoc_ERM$org_f),
                        selected = levels(aoc_ERM$org_f),
                        options = list(`actions-box` = TRUE), 
                        multiple = TRUE)), 
                      ...
                      column(width = 3, 
                        ...
                        choices = levels(aoc_ERM$bio_f),
                        selected = levels(aoc_ERM$bio_f),
                        options = list(`actions-box` = TRUE),
                        multiple = TRUE))), 
                    ...
                    column(width = 12,
                      ...
                      column(width = 3,
                        ...
                        label = "Shape:", 
                        choices = levels(aoc_ERM$shape_f),
                        selected = levels(aoc_ERM$shape_f),
                        options = list(`actions-box` = TRUE), 
                        multiple = TRUE)),
                      ...
                      column(width = 3,
                        ...
                        label = "Environment:", 
                        choices = levels(aoc_ERM$env_f),
                        selected = levels(aoc_ERM$env_f),
                        options = list(`actions-box` = TRUE), 
                        multiple = TRUE)),
                    ...
                    column(width = 12,
                      ...
                      column(width = 3,
                        ...
                        label = "Effect:",
                        choices = levels(aoc_ERM$effect_f),
                        selected = levels(aoc_ERM$effect_f),
                        options = list(`actions-box` = TRUE),
                        multiple = TRUE)),
                      ...
                      column(width = 3,
                        ...
                        label = "Size Category:", 
                        choices = levels(aoc_ERM$size_f),
                        selected = levels(aoc_ERM$size_f),
                        options = list(`actions-box` = TRUE), 
                        multiple = TRUE)),
                      ...
                      column(width = 3,
                        ...
                        label = "Life Stages:", 
                        choices = levels(aoc_ERM$life_f),
                        selected = levels(aoc_ERM$life_f),
                        options = list(`actions-box` = TRUE), 
                        multiple = TRUE)),
                      ...
                      column(width = 3,
                             pickerInput(inputId = "acute.chronic_check", # chronic/acute checklist
                                         ...
                                         choices = levels(aoc_ERM$acute.chronic_f),
                                         selected = levels(aoc_ERM$acute.chronic_f),
                    ...
                    column(width = 12,
                           ...
                           column(width = 3,
                                  pickerInput(inputId = "tech_tier_zero_check", # chronic/acute checklist
                                              ...
                                              choices = levels(aoc_ERM$tier_zero_tech_f),
                                              selected = levels(aoc_ERM$tier_zero_tech_f),
                                              options = list(`actions-box` = TRUE), 
                                              multiple = TRUE)),
                           ...
                           column(width = 3,
                                  radioButtons(inputId = "ERM_check", # ERM (particle, surface area, mass, volume, specific surface area)
                                               ...
                                               choices = c("Particles", "Surface Area", "Volume", "Mass", "Specific Surface Area"),
                                               selected = "Particles")),
                  ...
                  column(width = 12,
                         ...
                         column(width = 3,
                                pickerInput(inputId = "risk_tier_zero_check", # chronic/acute checklist
                                            ...
                                            choices = levels(aoc_ERM$tier_zero_risk_f),
                                            selected = levels(aoc_ERM$tier_zero_risk_f),
                                            options = list(`actions-box` = TRUE), 
                                            multiple = TRUE)),
...
#### Future Risk Modelling UI ####

tabPanel("8: Spatial Risk Modelling Over Time", 
         br(), # line break
         h3("Spatial Risk Modelling Over Time", align = "center"),
         p("Risk to aquatic ecosystems is modeled over time by displaying the concentrations of floating marine microplastics from 1961 to 2100 based on different scenarios for global plastic production. The tab is ported adapted from", a(href = "https://rshiny.lifewatch.be/ng-ocean-plastic-challenge/", "rshiny.lifewatch.be/ng-ocean-plastic-challenge"), ". Developers include Flanders Marine Institute R Code Club: Gert Everaert, Jelle Rondelez, Lennert Schepers, Nick Dillen, Lisa Devriese and others."),
         br()
         ) #Closes out tab 8
...
#### Exploration AO S ####
  ...
  output$secondSelection <- renderUI({
    ...
    aoc_new <- aoc_ERM %>% # take original dataset
  ...
  output$organism_plot_react <- renderPlot({
    ...
    p <- ggplot(aoc_filter(), aes(x = dose_new, y = org_f, fill = effect_f)) +
      ...
      labs(x = input$dose_check,
           ...
           color = "Effect?",
           fill = "Effect?"#,
           #caption = paste(input$Rep_Con_rad, input$ERM_check)
           ) %>%
