...
map <- pheatmap(MissingMatrix_size,
         ...
         color = c("#EEFFFF", "#BAFFFF", "#88E7FF", "#55B4CC", "#3B9AB2", "#228199")) 
...
ggplot(aes(x = est, y = percent/100, color = size)) +
  ...
  scale_fill_manual(values = c("#FF0000", "#00A08A", "#F2AD00", "#5BBCD6"),name = "Size Bins") +
  scale_color_manual(values = c("#FF0000", "#00A08A", "#F2AD00", "#5BBCD6"),name = "Size Bins") +
