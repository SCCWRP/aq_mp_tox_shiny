...
all <- ggroc(roc.all) + labs(title = "Chronic and Acute",
                             subtitle = "Accuracy = 81.7%, n = 1510") +
  theme_minimal()
acute <- ggroc(roc.acute, col = "red") + labs(title = "Acute",
                                              subtitle = "Accuracy = 84.8%, n = 883") + theme_minimal()
chronic <- ggroc(roc.chronic, col = "blue") + labs(title = "Chronic",
                                                   subtitle = "Accuracy = 67.3%, n = 452") + theme_minimal()
 
nofilter<- ggroc(roc.nofilter, col = "green") + labs(title = "Entire Dataset",
                                                   subtitle = "Accuracy = 79.9%, n = 4615") + theme_minimal()
require(gridExtra)
grid.arrange(all, acute, chronic, nofilter,
             ncol = 4)
```
